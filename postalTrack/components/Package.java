 ...
 * <br>This class represents universal packages
 */
...
public abstract class Package {
	...
	public Package(Priority priority, Address senderAddress,Address destinationAdress) {
		...
		addTracking(new Tracking( MainOffice.getClock(), null, status), this);
	...
	public void addTracking(Node node, Status status,Package p) {
		addTracking(new Tracking(MainOffice.getClock(), node, status),p);
	}
	
	public void addTracking(Tracking t, Package p) {
		tracking.add(t);
		MainOffice.WriteTraking(new Registration(p));
	}
	...
	/**
	 * print the tracking list of the package
	 */
